...
public class OAuthClientInterceptor implements ClientHttpRequestInterceptor {
    ...
    public OAuthClientInterceptor(@Qualifier("authorizedClientManager") OAuth2AuthorizedClientManager manager, ClientRegistrationRepository clientRegistrationRepository) {
